...
const bool static_target = false, use_perception = true, drone_moving = true, use_cineMPC = true, log_costs = true,
           dynamic_scene = true, publish_topics_gt = true;
...
const double z_lowest = -20, z_highest = 20;  // z_higuest depends on floor
...
const double velos = 25 * sim_speed;
...
const double tolerance_pixel_x = 4;
const double tolerance_pixel_y = 10;
...
const int start_sequence_3 = 55;
const int start_sequence_4 = 85;
...
const double kf_dt = 0.6;
const double kf_a = 1, kf_c = 1, kf_q = 1, kf_r = 0.5, kf_p = 2;
const double kf_init_x = 0, kf_init_y = -20, kf_init_z = 0, kf_init_vx = 0, kf_init_vy = -4, kf_init_vz = 0;