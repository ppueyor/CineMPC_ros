...
std::string plotValues(cinempc::PlotValues plot_values, bool header)
{
  ...
  else
  {
    result << plot_values.time_ms << "," << plot_values.sequence << "," << plot_values.target_world_gt.x << ","
           ...
           << plot_values.intrinsics_camera.focal_length << "," << plot_values.intrinsics_camera.focus_distance << ","
           << plot_values.intrinsics_camera.aperture << "," << plot_values.mpc_plot_values.dn << ","
           ...
           << plot_values.constraints.df_star << "," << plot_values.mpc_plot_values.relative_pitch << ","
           << plot_values.mpc_plot_values.relative_yaw << ","
